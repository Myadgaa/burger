...
export class TabBodySeeker extends Component {
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10 col-sm-10 col-xl-10 mb-3 input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="first-name"><icon class="fa fa-user icon"></icon></span>
                                </div>
                                <input type="text" class="form-control is-valid" id="name-first" name="name-first" placeholder="Өөрийн нэр"></input>
                            </div>
                            <label class="col-2 col-sm-2 col-xl-2 col-md-2 col-lg-2 col-form-label mb-3" for="name-last">Last name</label>
                            <div class="col-10 col-sm-10 col-xl-10 mb-3 input-group">
                                <div class="input-group-prepend">
                            ...
                            <label class="col-2 col-sm-2 col-xl-2 col-md-2 col-lg-2 col-form-label mb-3" for="name-first">Sure name</label>
                            <div class="col-10 col-sm-10 col-xl-10 mb-3 input-group">
                                <div class="input-group-prepend">
                            ...
                            <label class="col-2 col-sm-2 col-xl-2 col-md-2 col-lg-2 col-form-label mb-3" for="name-sure">Choose file</label>
                            <div class="col-10 col-sm-10 col-xl-10 mb-3 input-group">
                                <div class="input-group-prepend">
                            ...
                            <label class="col-2 col-sm-2 col-xl-2 col-md-2 col-lg-2 col-form-label mb-3" for="name-sure">Province birth</label>
                            <div class="col-10 col-sm-10 col-xl-10 mb-3 input-group">
                                <div class="input-group-prepend">
                            ...
                            <label class="col-2 col-sm-2 col-xl-2 col-md-2 col-lg-2 col-form-label mb-3" for="name-sure">District birth</label>
                            <div class="col-10 col-sm-10 col-xl-10 mb-1 input-group">
                                <div class="input-group-prepend">
                            ...
                            <div class="col-10 col-sm-10 col-xl-10 mb-1 input-group">
                                <div class="input-group mb-3">
                                    <div class="input-gr oup-prepend">
                                        <span class="input-group-text" id="inputGroup-sizing-check"><i
                                            class="fa fa-check icon"></i></span>
                                    </div>
